...
// export const sendPendingEmail = async (userName: string, userEmail: string, packageId: string): Promise<void> => {
...
// export const sendConfirmedEmail = async (userName: string, userEmail: string, packageId: string): Promise<void> => {
...
// export const sendTransitEmail = async (userName: string, userEmail: string, packageId: string): Promise<void> => {
...
// export const sendAvailableEmail = async (userName: string, userEmail: string, packageId: string): Promise<void> => {
...
// export const sendDeliveredEmail = async (userName: string, userEmail: string, packageId: string): Promise<void> => {
...
// Définition des statuts comme énumération pour les statuts connus
enum ShipmentStatus {
  CONFIRMED = 'Recu📦',
...
📩 N’hésitez pas à nous partager vos retours ou suggestions !`,
    html: `
      ...
      <p>📩 Partagez vos retours ou suggestions à <a href="mailto:support@pniceshipping.com">support@pniceshipping.com</a>.</p>
    `,
  },
  DEFAULT: {
...
🙏 Pour toute question, contactez-nous à support@pniceshipping.com.`,
    html: `
      <h1>Mise à jour de votre colis</h1>
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <p style="font-size: 14px;">
        ...
        <a href="mailto:support@pniceshipping.com">support@pniceshipping.com</a> ou via WhatsApp au 
