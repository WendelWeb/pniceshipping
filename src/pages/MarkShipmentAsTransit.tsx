...
const MarkShipmentAsTransit = () => {
  ...
  const [updatingShipments, setUpdatingShipments] = useState<Record<number, boolean>>({});
          ...
          {loading ? (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-3">
                {searchTerm ? "Aucun résultat trouvé 🔍" : "Tout est parti ! ✈️"}
              </h3>
                    ...
                    <div className="p-6">
                      <div className="space-y-4 mb-6">
                        ...
                        >
                          ...
                          <p className="text-slate-400 text-sm">Prêt pour expédition</p>
                        </motion.div>
                      </div>
                      ...
                      >
                        ...
                        <span className="text-xs text-slate-500 ml-2">Entrepôt → Transit</span>
                      </motion.div>
                    </div>
                  </motion.div>
                ))}
